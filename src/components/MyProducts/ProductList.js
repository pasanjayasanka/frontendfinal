...
export default function ProductList() {
    ...
    const productAPI = (url = 'https://localhost:44374/api/Product/') => {
        return {
            ...
            create: newRecord => axios.post('https://localhost:44374/api/ProductChecks/', newRecord),
            update: (id, updatedRecord) => axios.put(url + id, updatedRecord),
            delete: id => axios.delete(url + id),
            checkAll: () => axios.get('https://localhost:44374/api/ProductChecks/'),
            deleteCheck: id => axios.delete('https://localhost:44374/api/ProductChecks/' + id)
        }
    }
